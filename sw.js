const CACHE_NAME = "tiantian-checkin-v1.2.19";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=1.2.19",
  ...
  "./assets/figma/lion-success.png?v=1.2.19",
  "./assets/figma/modal-lion.png?v=1.2.19",
  "./assets/figma/revoke.svg",
  "./assets/figma/makeup.svg",
  "./assets/figma/poster-lion.png?v=1.2.19",
  ...
  "./assets/figma/profile-avatar.png?v=1.2.19",
