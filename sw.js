const CACHE_NAME = "tiantian-checkin-v1.2.17";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=1.2.17",
  ...
  "./assets/figma/lion-success.png?v=1.2.17",
  "./assets/figma/modal-lion.png",
  "./assets/figma/revoke.svg",
  "./assets/figma/makeup.svg",
  "./assets/figma/poster-lion.png?v=1.2.17",
  ...
  "./assets/figma/profile-avatar.png?v=1.2.17",
  "./assets/motion/confetti.json",
  "./assets/vendor/lottie.min.js?v=5.12.2",
