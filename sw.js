const CACHE_NAME = "tiantian-checkin-v1.2.21";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=1.2.21",
  ...
  "./assets/figma/lion-success.png?v=1.2.21",
  "./assets/figma/modal-lion.png?v=1.2.21",
  "./assets/figma/revoke.svg",
  "./assets/figma/makeup.svg",
  "./assets/figma/poster-lion.png?v=1.2.21",
  ...
  "./assets/figma/profile-avatar.png?v=1.2.21",
  "./assets/figma/qr-code.png",
  "./assets/figma/app-icon-192.png?v=1.2.21",
  "./assets/figma/app-icon-512.png?v=1.2.21",
