...
当前发布版本为 `1.2.21`，实现 [V1.1 产品规格](./docs/天天打卡_V1.1_PRD.md)。视觉以 [Figma 天天打卡](https://www.figma.com/design/fms7qDu4GjPsyWlEXG5tnh/%E5%A4%A9%E5%A4%A9%E6%89%93%E5%8D%A1?node-id=106-71) 的 13 个主流程画板和首次空首页为准。
...
- [产品开发交付文档](./docs/天天打卡-产品开发交付文档.md)：`1.2.21` 的现役实现、验收和发布结果。
...
- `docs/superpowers/`：已完成的正式版设计与实施历史，不作为当前待办。
